...
public class Kiosk {
	 ...
	 * <br><br>
	 	(L) Load the contents of a tree from a file. You should create a new Tree.
	 	<br><br>
        (P) Prints the menu in a neat tabular format.
        <br><br>
        (S) Starts a service session. Ask for the user's order, and print the order at the end.
        <br><br>
